 ...
 * </p>
 * <ul>
 *   <li>{@link timedStateMachine.impl.TimeEventImpl#getTime <em>Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeEventImpl extends MinimalEObjectImpl.Container implements TimeEvent {
	...
	protected EClass eStaticClass() {
		return TimedStateMachinePackage.Literals.TIME_EVENT;
	}
	...
	public void setTime(int newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimedStateMachinePackage.TIME_EVENT__TIME, oldTime,
					time));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case TimedStateMachinePackage.TIME_EVENT__TIME:
			return getTime();
		}
